 ...
 * @param {import('../Shared/Model/StyleModel.js').ButtonStyleProperties} style
 * @returns {{ width: number, height: number }}
 */
export function GetButtonBitmapSize(registry, style) {
	let removeTopBar = style.show_statusbar === 'hidden'
	if (style.show_statusbar === 'default' || style.show_statusbar === undefined) {
		removeTopBar = registry.userconfig.getKey('show_statusbar') === 'hidden'
	}
...
/**
 *
 * @param {Partial<import('@companion-module/base').CompanionButtonStyleProps> | undefined} style
 * @returns {Partial<import('../Shared/Model/StyleModel.js').ButtonStyleProperties> | undefined}
 */
export function translateStyleFromModule(style) {
	if (!style) return undefined

	return {
		...style,
		show_statusbar: style.show_topbar !== undefined ? translateShowStatusBarFromBoolean(style.show_topbar) : undefined,
	}
}

/**
 *
 * @param {import('@companion-module/base').CompanionButtonStyleProps['show_topbar']} show_topbar
 * @returns {import('../Shared/Model/StyleModel.js').ButtonStyleProperties['show_statusbar']}
 */
export function translateShowStatusBarFromBoolean(show_topbar) {
	if (show_topbar === true) {
		return 'top'
