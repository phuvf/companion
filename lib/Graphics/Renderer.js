...
const internalIcons = {
	...
	cloud:
		`<?xml version="1.0"?>
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="137" height="79.73" viewBox="0 0 137 79.73"><defs><radialGradient id="a" cx="93.39" cy="5.03" fx="70.84384464891221" r="115.7" gradientTransform="matrix(-0.69, 0.72, -0.51, -0.49, 160.49, -59.36)" gradientUnits="userSpaceOnUse"><stop offset="0.07" stop-color="#fff"/><stop offset="0.26" stop-color="#fcfcff"/><stop offset="0.41" stop-color="#f1f1ff"/><stop offset="0.56" stop-color="#e0e0ff"/><stop offset="0.7" stop-color="#c8c8ff"/><stop offset="0.83" stop-color="#a8a8ff"/><stop offset="0.96" stop-color="#8282ff"/><stop offset="1" stop-color="#7575ff"/></radialGradient></defs><title>cloud4</title><path d="M116.39,79.86c12.21,0,22.11-9.42,22.11-21,0-10-7.31-18.34-17.1-20.49C121.19,17.2,103.15.14,80.91.14A40.83,40.83,0,0,0,45.45,20.06a17.84,17.84,0,0,0-6.85-1.35c-8.76,0-16,6.22-17.1,14.28-11.4,2.15-20,11.72-20,23.21,0,13.07,11.13,23.66,24.86,23.66Z" transform="translate(-1.5 -0.14)" style="fill:url(#a)"/></svg>
		`
}
...
export default class GraphicsRenderer {
	...
	static #drawTopbar(img, show_topbar, bankStyle, location) {
		...
		if (bankStyle.cloud && show_topbar) {
			img.drawFromSVGdata( internalIcons.cloud, rightMax - 16, 3, 14, 8, 'center', 'center', 'fit')
			rightMax -= 16
		}
