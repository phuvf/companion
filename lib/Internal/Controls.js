...
const ButtonStylePropertiesExt = [
	...
	{ id: 'show_statusbar', label: 'Status bar' },
...
export default class Controls {
	...
	feedbackUpgrade(feedback, _controlId) {
		...
		if (feedback.type === 'bank_style') {
			const index = feedback.options.properties.indexOf('show_topbar')
			if (index !== -1) feedback.options.properties[index] = 'show_statusbar'
		}
